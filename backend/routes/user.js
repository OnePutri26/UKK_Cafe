...
// get all data user
app.get("/getAllData", 
 async (req, res) => { // endpoint untuk mengambil semua data user
  await user
...
// get data by id user
app.get("/getById/:id",  async (req, res) => { // endpoint untuk mengambil data user berdasarkan id user
  await user
...
// get data by role
app.get("/getByRole/:role",  async (req, res) => { // endpoint untuk mengambil data user berdasarkan role
  await user
...
// delete user
app.delete("/delete/:id_user", async (req, res) => { // endpoint untuk menghapus data user berdasarkan id user
...
// edit user
app.patch("/edit/:id_user", async (req, res) => { // endpoint untuk mengubah data user berdasarkan id user
...
// search user
app.get("/search/:nama_user",  async (req, res) => { // endpoint untuk mencari data user berdasarkan nama user
  user 
